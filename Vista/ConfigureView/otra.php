      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" onclick="location.href='../ConfigureView/otra.php'" data-dismiss="modal" aria-hidden="true">&times;</button>
              ...
              <div class="col-md-12">
                <div class="form-horizontal" style="">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="from-control" id="txt_Codigo"  name="txt_Codigo"/>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="txt_Nombre">Nombre Documento: </label>
                        <div class="col-sm-10">
                          <input type="text" class="from-control" id="txt_Nombre"  name="txt_Nombre"/>
                        </div>
                    </div>
                    <div class="form-group">
                      <div id="result"></div>
